...
pub fn get_universe_clock(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.universe_clock).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_universe_clock(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_first_person_camera_control(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.first_person_camera_control).map_err(serde_serialize_err_map)?
    ))
}
...
pub fn get_third_person_orbit_camera_control(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.third_person_orbit_camera_control).map_err(serde_serialize_err_map)?
    ))
}
...
pub fn get_third_person_static_camera_control(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.third_person_static_camera_control).map_err(serde_serialize_err_map)?
    ))
}
...
pub fn get_transform(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.transform).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_transform(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_real_physics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.real_physics).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_real_physics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_simple_physics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.simple_physics).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_simple_physics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ship_control(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ship_control).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ship_control(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ui_color(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_color).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ui_color(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ui_hover_color(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_hover_color).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ui_hover_color(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ui_box(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_box).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ui_box(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ui_hover_cursor(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_hover_cursor).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ui_hover_cursor(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ui_texture(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_texture).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ui_texture(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_ui_text(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(
        &ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_text).map_err(serde_serialize_err_map)?
    ))
}

pub fn set_ui_text(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
...
pub fn get_set_physics_kinematics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.set_physics_kinematics).map_err(serde_serialize_err_map)?))
}
...
pub fn get_mesh(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.mesh).map_err(serde_serialize_err_map)?))
}
...
pub fn get_camera_focus(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.camera_focus).map_err(serde_serialize_err_map)?))
}
...
pub fn get_is_ground_collider(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.is_ground_collider).map_err(serde_serialize_err_map)?))
}
...
pub fn get_is_player(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.is_player).map_err(serde_serialize_err_map)?))
}
...
pub fn get_control_focus(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.control_focus).map_err(serde_serialize_err_map)?))
}
...
pub fn get_ui_is_raycastable(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_is_raycastable).map_err(serde_serialize_err_map)?))
}
...
pub fn get_ui_require_free_cursor(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    ...
    Ok(Some(serde_json::to_string(&ecs.find_by_id(input.entity_id).ok_or("Entity not found")?.components.ui_require_free_cursor).map_err(serde_serialize_err_map)?))
}
