...
pub fn set_universe_clock(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUniverseClockInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_transform(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetTransformInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_real_physics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetRealPhysicsInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_simple_physics(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetSimplePhysicsInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ship_control(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetShipControlInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ui_color(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUIColorInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ui_hover_color(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUIHoverColorInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ui_box(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUIBoxInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ui_hover_cursor(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUIHoverCursorInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ui_texture(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUITextureInput = serde_json::from_str(payload).map_err(serde_err_map)?;
...
pub fn set_ui_text(payload: &str, ecs: &mut ECSWorld) -> Result<Option<String>, String> {
    let mut input: SetUITextInput = serde_json::from_str(payload).map_err(serde_err_map)?;
