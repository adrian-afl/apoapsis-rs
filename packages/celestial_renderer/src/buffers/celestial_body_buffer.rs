...
impl CelestialBodyBuffer {
    ...
    */
    pub fn update(
        ...
        let mut translation_camera_space = &body.position - camera_position;
        // dbg!(&translation_camera_space.to_string());
        translation_camera_space.clamp_f64(-69634000000.0, 69634000000.0);
